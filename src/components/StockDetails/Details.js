...
const Details = () => {
    ...
    return (
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg max-w-6xl mx-auto my-10 border">
            ...
            <table className="w-full mx-auto text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            </table>
            {
                !searchText && <div className='px-5'>
                    <div className='flex justify-end items-center'>
                        <div className="px-6 py-4">{(currentPage * 5) + 1}-{5 * (currentPage + 1)} of {fullStocks?.length}</div>
                        <div>
